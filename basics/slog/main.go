...
// LogValuer If a type implements the LogValuer interface, the Value returned from its LogValue method is used for logging
...
func main() {
	logWithLevels()
	// Write log as key-value pairs accept a log message as their first argument,
